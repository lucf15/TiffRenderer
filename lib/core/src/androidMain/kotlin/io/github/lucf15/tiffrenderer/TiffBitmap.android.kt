...
public actual class TiffBitmap(internal val bitmap: Bitmap) {
    init {
...
public fun TiffBitmap.asAndroidBitmap(): Bitmap = bitmap

public actual fun createTiffBitmap(width: Int, height: Int): TiffBitmap =
