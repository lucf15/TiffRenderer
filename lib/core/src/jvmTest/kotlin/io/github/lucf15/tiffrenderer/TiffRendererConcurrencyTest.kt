 ...
 * correct, and that two independent documents (two separate locks) don't corrupt each other. */
class TiffRendererConcurrencyTest {
    ...
    @Test
    fun render_concurrentCallsOnSamePage_allProduceCorrectPixels() {
    ...
    @Test
    fun render_twoIndependentRenderersOnSeparateThreads_neitherCorruptsTheOther() {
        val failures = ConcurrentLinkedQueue<String>()
